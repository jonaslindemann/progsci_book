...
\newenvironment{mintfor}
{\begin{minted}[bgcolor=mintedbackground,baselinestretch=1.2,fontsize=\footnotesize,linenos]{python}}
{\end{minted}}

\newcommand{\mintforfile}[1]
{\inputminted[bgcolor=mintedbackground,baselinestretch=1.2,fontsize=\footnotesize,linenos]{fortran}{#1}}
