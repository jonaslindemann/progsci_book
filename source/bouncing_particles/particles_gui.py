...
class Particle(object):
    ...
    def update(self):
        Particle.canvas.coords(self.id,
                               int(Particle.positions[self._i,0]*Particle.scaleX-Particle.sizes[self._i]*Particle.scaleX),
                               int(Particle.positions[self._i,1]*Particle.scaleY-Particle.sizes[self._i]*Particle.scaleX),
                               int(Particle.positions[self._i,0]*Particle.scaleX+Particle.sizes[self._i]*Particle.scaleX),
                               int(Particle.positions[self._i,1]*Particle.scaleY+Particle.sizes[self._i]*Particle.scaleX)
                               )
